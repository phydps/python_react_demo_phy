...
def add():
    ...
    isOk = db.modify(sql='insert into user(name,age,sex,mobile,address) values(%s,%s,%s,%s,%s)',
                      args=[data['name'], data['age'], data['sex'], data['mobile'], data['address']])
...
def update():
    ...
    isOk = db.modify(sql='update user set name=%s,age=%s,sex=%s,address=%s,mobile=%s where id=%s',
                      args=[data['name'], data['age'], data['sex'], data['address'], data['mobile'], data['id']])
